...
To use the prefered form of the CANDRA E vowels please see the [FAQ](faq.md).

These fonts will work normally like any other fonts in most applications that support a sufficient level of OpenType.

For information on the specific features available in these fonts see [Font features](features.md).
...
Web font versions of these fonts (in WOFF2 format) are available in the `web` folder. These can be copied to a web server and used as fonts on web pages. A very basic HTML/CSS demo page is also included. For more information on the options and techniques available for using these fonts on web pages see [Using SIL Fonts on Web Pages](https://software.sil.org/fonts/webfonts/).
